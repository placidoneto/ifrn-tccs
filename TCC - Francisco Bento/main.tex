...
% Variables
\newcommand{\thesistitle}{Explorando Regiões Densas Interessantes e Discrepâncias em Dados Espaciais}
\newcommand{\thesisauthor}{Francisco Bento da Silva Júnior }
\newcommand{\thesissupervisor}{Dr. Plácido Antônio de Souza Neto}
\newcommand{\thesisdefencecommitteemembershipone}{Dra. Marília Aranha Freire}
\newcommand{\thesisdefencecommitteemembershiptwo}{Dr. Jorgiano Márcio Bruno Vidal}
...
\listadeabreviaturas
% TODO: adicionar IDR e verificar onde foi o primeiro uso
...
\include{capitulos/Outliers}

\include{capitulos/IDRs}
